...
from transformers import T5Config, PreTrainedModel
from transformers.activations import ACT2FN
from transformers.modeling_outputs import BaseModelOutputWithPastAndCrossAttentions

logger = logging.getLogger(__name__)

__all__ = ['T5Stack', 'T5PreTrainedModel']


T5LayerNorm = nn.RMSNorm
...
class T5SdpaAttention(nn.Module):
...
class T5LayerSelfAttention(nn.Module):
    def __init__(self, config, has_relative_attention_bias=False):
        super().__init__()
        self.SelfAttention = T5SdpaAttention(config,
...
class T5LayerCrossAttention(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.self.EncDecAttention = T5SdpaAttention(config,
